...
@Component({
  ...
  <g
     ...
     id="layer1">
    <path #up [style.fill] = "_dragState == DragState.Up ? RadialMenuComponent.ACTIVE_COLOR: RadialMenuComponent.INACTIVE_COLOR"
    ...
    <path #right [style.fill] = "_dragState == DragState.Right ? RadialMenuComponent.ACTIVE_COLOR: RadialMenuComponent.INACTIVE_COLOR"
    ...
    <path #left [style.fill] = "_dragState == DragState.Left ? RadialMenuComponent.ACTIVE_COLOR: RadialMenuComponent.INACTIVE_COLOR"
    ...
    <path #down [style.fill] = "_dragState == DragState.Down ? RadialMenuComponent.ACTIVE_COLOR: RadialMenuComponent.INACTIVE_COLOR"
...
export class RadialMenuComponent {
    ...
    static get ACTIVE_COLOR(): string { return '#606c63'; };
    static get INACTIVE_COLOR(): string { return '#a0aba3'; };
